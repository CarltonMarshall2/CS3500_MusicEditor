...
/**
 * Tests for MusicReader
 */
public class MusicReaderTests {

  @Test
  public void testReadFromFile() {

    String file = "/Users/spencerdodd/Documents/School/Year_5_Spring_2016/CS3500/Homework" +
            "/hw06/mary-little-lamb.txt";

    String maryLittleLamb = "    G#3  A3   A#3  B3   B#3  C4   C#4  D4   D#4  E4   E#4  " +
            "F4   F#4  G4   G#4  A4 \n" +
            "0                  X                                            X                 \n" +
            "1                  |                                            |                 \n" +
            "2                  |                                  X                           \n" +
    ...
    try {
      ...
      assertEquals(editor.getClipState(), maryLittleLamb);
